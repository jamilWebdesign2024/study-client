                    ...
                    >
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
                            {allSessions.map((session) => {
                                ...
                                return (
                                    <div
                                        key={session._id || Math.random().toString(36).substr(2, 9)}
                                    ...
                                    >
                                        <div className="relative">
                                            ...
                                            <span className={`absolute top-3 left-3 ${
                                                sessionStatus === 'upcoming' ? 'bg-blue-500' :
                                                sessionStatus === 'ongoing' ? 'bg-green-500' : 
                                                sessionStatus === 'closed' ? 'bg-gray-500' : 'bg-yellow-500'
                                        ...
                                        <div className="p-4 space-y-2">
                                            ...
                                            <div className="space-y-2 text-sm mt-3">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span>
                                                        {session.registrationStartDate ? 
                                                            dayjs(session.registrationStartDate).format('MMM D') : 'N/A'} -{' '}
                                                        {session.registrationEndDate ? 
                                                            dayjs(session.registrationEndDate).format('MMM D, YYYY') : 'N/A'}
                                                    </span>
                                                </div>
                                                <div className="flex items-center gap-2">
