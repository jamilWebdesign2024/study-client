...
const TutorDashboard = () => {
  ...
  return (
    <div className="max-w-7xl bg-base-300 mx-auto p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
        <div className="card bg-accent/3 text-base-content shadow p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div className="card bg-accent/3 text-base-content shadow p-4">
          ...
          {bookingCounts.length > 0 ? (
            ...
            <p className="text-center text-primary">No bookings yet</p>
          )}
        </div>
        ...
        <div className="card bg-base-100 shadow p-4">
          ...
          {bookingCounts.length > 0 ? (
            ...
            <p className="text-center text-primary">No bookings to display</p>
          )}
        </div>
      </div>
    </div>
